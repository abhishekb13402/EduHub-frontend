      ...
      {/* <a className="navbar-brand" href="#"> <img src="/EduHub_logo.png" alt="EduHub Logo" height="40" /></a> */}
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <a className="nav-link active" aria-current="page" href="./Pages/About">Aboutℹ️</a>
            </li>
            <li className="nav-item">
              <a className="nav-link active" aria-current="page" href="./Pages/Course">Courses📚</a>
            </li>
            <li className="nav-item">
              <a className="nav-link active" aria-current="page" href="./Pages/Login">Login🔐</a>
            </li>
